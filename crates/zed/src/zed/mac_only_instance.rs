...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Nucleus Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Nucleus Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Nucleus Editor Preview Instance Running",
        ReleaseChannel::Stable => "Nucleus Editor Stable Instance Running",
    }
}
